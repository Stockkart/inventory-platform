...
export const analyticsKeys = {
  ...
  inventory: (params: InventoryAnalyticsParams) => [...base.all, 'inventory', params] as const,
  vendors: (params: VendorAnalyticsParams) => [...base.all, 'vendors', params] as const,
  customers: (params: CustomerAnalyticsParams) => [...base.all, 'customers', params] as const,
