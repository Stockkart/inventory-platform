...
/**
 * Download a binary MIS report file — same axios blob pattern as accounting exports.
 */
export async function downloadMisBlob(
  path: string,
...
/**
 * Open PDF in a new tab; fall back to download if blocked.
 */
