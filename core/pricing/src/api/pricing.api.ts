...
import type {
  ...
  PatchPricingDto,
  PricingResponse,
} from '@inventory-platform/pricing/types';
...
export const pricingApi = {
  ...
  update: async (pricingId: string, data: PatchPricingDto): Promise<PricingResponse> => {
  ...
  bulkUpdate: async (updates: BulkPricingUpdateDto['updates']): Promise<PricingResponse[]> => {
