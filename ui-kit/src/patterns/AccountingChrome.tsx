...
export const accountingChrome = {
  ...
  overviewKpiCardCenter: styles.overviewKpiCardCenter,
  ...
  misDateCol: styles.misDateCol,
  misPartyCol: styles.misPartyCol,
  misTxnTypeCol: styles.misTxnTypeCol,
  misInvoiceCol: styles.misInvoiceCol,
  misTxnIdCol: styles.misTxnIdCol,
  misTxnId: styles.misTxnId,
  misNumCol: styles.misNumCol,
  misNarrationCol: styles.misNarrationCol,
  misFilterRow: styles.misFilterRow,
  misFilterCompact: styles.misFilterCompact,
  misFilterMoney: styles.misFilterMoney,
  misFilterSearch: styles.misFilterSearch,
  misFilterActions: styles.misFilterActions,
